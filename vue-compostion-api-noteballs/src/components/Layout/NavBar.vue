...
<nav class="navbar is-success" role="navigation" aria-label="main navigation">
  <dis class="container is-max-desktop px-2"></dis>
    <div class="navbar-brand">
      ...
      <a @click.prevent="showMobileNav = !showMobileNav" 
        role="button" class="navbar-burger" :class="{'is-active': showMobileNav}" aria-label="menu" aria-expanded="false" data-target="navbarBasicExample">
